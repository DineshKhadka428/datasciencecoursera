...
getwd() # "Users/data/UCI HAR Dataset/"

######## loading data from each folder train and test
...
tidy_data <- ddply(single_data, .(subject, activity), function(x) colMeans(x[, 1:66]))
